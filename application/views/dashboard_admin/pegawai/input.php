  ...
  <body>
    ...
    <div id="myTabContent" class="tab-content">
        ...
        <div class="control-group">
		  ...
		  <div class="control-group">
			<label class="control-label" for="nip_lama">NIK</label>
			<div class="controls">
			<?php
			if($st=="tambah")
			{
			?>
			  <input type="text" class="span6" name="nip_lama" id="nip_lama" value="<?php echo set_value('nip_lama'); ?>" placeholder="NIK">
			<?php
			}
			else
			{
		  ...
		  <div class="control-group">
			<label class="control-label" for="kartu_askes_pegawai">Kartu BPJS Kesehatan</label>
			<div class="controls">
			<?php
			if($st=="tambah")
			{
		  ...
		  <div class="control-group">
			...
			{
			?>
			  <input type="date" class="span6" name="tanggal_lahir" id="tanggal_lahir" value="<?php echo set_value('tanggal_lahir'); ?>" placeholder="Tanggal Lahir">
			<?php
			}
			else
			{
			?>
			  <input type="date" class="span6" name="tanggal_lahir" id="tanggal_lahir" value="<?php echo $tanggal_lahir; ?>" placeholder="Tanggal Lahir">
			<?php
			}
			?>
			</div>
		  ...
		  <div class="control-group">
			<label class="control-label" for="tanggal_pengangkatan_cpns">Tanggal Masuk</label>
			<div class="controls">
			<?php
			if($st=="tambah")
			{
			?>
			  <input type="date" class="span6" name="tanggal_pengangkatan_cpns" id="tanggal_pengangkatan_cpns" value="<?php echo set_value('tanggal_pengangkatan_cpns'); ?>" placeholder=
			...
			{
			?>
			  <input type="date" class="span6" name="tanggal_pengangkatan_cpns" id="tanggal_pengangkatan_cpns" value="<?php echo $tanggal_pengangkatan_cpns; ?>" placeholder=
			  "Tanggal Pengangkatan CPNS">
			<?php
			}
			?>
        ...
        <div class="tab-pane fade" id="dtpangkat">
          ...
          <div class="control-group">
			...
			{
			?>
			  <input type="date" class="span6" name="tanggal_sk_pangkat" id="tanggal_sk_pangkat" value="<?php echo set_value('tanggal_sk_pangkat'); ?>" placeholder=
			  "Tanggal SK Pangkat">
			<?php
			}
			else
			{
			?>
			  <input type="date" class="span6" name="tanggal_sk_pangkat" id="tanggal_sk_pangkat" value="<?php echo $tanggal_sk_pangkat; ?>" placeholder=
			  "Tanggal SK Pangkat">
			<?php
			}
			?>
          ...
          <div class="control-group">
			...
			{
			?>
			  <input type="date" class="span6" name="tanggal_mulai_pangkat" id="tanggal_mulai_pangkat" value="<?php echo set_value('tanggal_mulai_pangkat'); ?>" placeholder=
			...
			{
			?>
			  <input type="date" class="span6" name="tanggal_mulai_pangkat" id="tanggal_mulai_pangkat" value="<?php echo $tanggal_mulai_pangkat; ?>" placeholder=
			  "Tanggal Mulai Pangkat">
			<?php
			}
			?>
          ...
          <div class="control-group">
			...
			{
			?>
			  <input type="date" class="span6" name="tanggal_selesai_pangkat" id="tanggal_selesai_pangkat" value="<?php echo set_value('tanggal_selesai_pangkat'); ?>" placeholder=
			...
			{
			?>
			  <input type="date" class="span6" name="tanggal_selesai_pangkat" id="tanggal_selesai_pangkat" value="<?php echo $tanggal_selesai_pangkat; ?>" placeholder=
			  "Tanggal Selesai Pangkat">
			<?php
			}
			?>
        ...
        <div class="tab-pane fade" id="dtjabatan">
          ...
          <div class="control-group">
			...
			{
			?>
			  <input type="date" class="span6" name="tanggal_sk_jabatan" id="tanggal_sk_jabatan" value="<?php echo set_value('tanggal_sk_jabatan'); ?>" placeholder=
			  "Tanggal SK Jabatan">
			<?php
			}
			else
			{
			?>
			  <input type="date" class="span6" name="tanggal_sk_jabatan" id="tanggal_sk_jabatan" value="<?php echo $tanggal_sk_jabatan; ?>" placeholder=
			  "Tanggal SK Jabatan">
			<?php
			}
			?>
          ...
          <div class="control-group">
			...
			{
			?>
			  <input type="date" class="span6" name="tanggal_mulai_jabatan" id="tanggal_mulai_jabatan" value="<?php echo set_value('tanggal_mulai_jabatan'); ?>" placeholder=
			...
			{
			?>
			  <input type="date" class="span6" name="tanggal_mulai_jabatan" id="tanggal_mulai_jabatan" value="<?php echo $tanggal_mulai_jabatan; ?>" placeholder=
			  "Tanggal Mulai Jabatan">
			<?php
			}
			?>
          ...
          <div class="control-group">
			...
			{
			?>
			  <input type="date" class="span6" name="tanggal_selesai_jabatan" id="tanggal_selesai_jabatan" value="<?php echo set_value('tanggal_selesai_jabatan'); ?>" placeholder=
			...
			{
			?>
			  <input type="date" class="span6" name="tanggal_selesai_jabatan" id="tanggal_selesai_jabatan" value="<?php echo $tanggal_selesai_jabatan; ?>" placeholder=
			  "Tanggal Selesai Jabatan">
			<?php
			}
			?>
        ...
        <div class="tab-pane fade" id="dtfoto">
		  ...
		  <script src="<?=base_url();?>/asset/js/chosen.jquery.js" type="text/javascript"></script>
			<script type="text/javascript"> 
				$(".chzn-select").chosen();
			</script>
