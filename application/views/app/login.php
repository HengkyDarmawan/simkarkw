  ...
  <body>
      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <div class="nav-collapse collapse">
			...
			<?php echo form_open('index.php/app/index','class="navbar-form pull-right"'); ?>
	...
	<?php } ?>
      <div class="hero-unit">
        ...
        <p>Sistem Informasi Kepegawaian merupakan sebuah aplikasi untuk melakukan manajemen data kepegawaian untuk pegawai UNDIRA. Silahkan masukkan username dan password anda untuk mulai untuk melakukan manajemen atau pengolahan data kepegawaian sesuai dengan hak akses yang anda miliki.</p>
