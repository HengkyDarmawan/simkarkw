	...
	*/
	...
	public function cari()
	{
		if($this->session->userdata('logged_in')!="" && $this->session->userdata('stts')=="administrator")
		{
			...
			$d['data_pegawai'] = $this->db->query("select a.nip, a.nama_pegawai, b.golongan, c.nama_status, a.id_pegawai, a.id_pegawai,u.nama_unit_kerja as 'unit_kerja' from tbl_data_pegawai a left join tbl_master_golongan b on a.id_golongan=b.id_golongan
			left join tbl_master_status_pegawai c on a.status_pegawai=c.id_status_pegawai 
			left join tbl_master_unit_kerja u on u.id_unit_kerja = a.id_unit_kerja
			where a.nama_pegawai like '%".$kata."%' limit ".$offset.",".$limit."");
